...
from django.contrib.auth.forms import UserCreationForm,AuthenticationForm,UsernameField,PasswordChangeForm,PasswordResetForm,SetPasswordForm,SetPasswordForm
...
class MySetPassword(SetPasswordForm):
    new_password1 = forms.CharField(
        ...
        strip=False,
        widget=forms.PasswordInput(attrs={'class':"form-control",'autofucus':True,'autocomplete':'current-password'}),
        help_text=password_validation.password_validators_help_text_html(),
    )
